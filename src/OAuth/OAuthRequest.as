package OAuth
{
        ...
        */
        public class OAuthRequest
        {
                 ...
                 * Constructor method.
                */
                public function OAuthRequest(httpMethod:String,requestURL:String,requestParams:Object=null,consumer:OAuthConsumer=null,token:OAuthToken=null, pin:String=null)
                {
                ...
                */
				...
				public function set pin(val:String):void {
					 if (val != _pin)
                        _pin = val;
				}
                ...
                */
                public function buildRequest(signatureMethod:IOAuthSignatureMethod,resultType:String=RESULT_TYPE_URL_STRING,headerRealm:String=""):* {
                        ...
                        if (_pin)
                        {
                        	_requestParams["oauth_verifier"] = _pin;
                        	_requestParams["oauth_callback"] = "oob";
                        }
